...
qbar=value get "EI_4leaves_tensor_id.txt";
...
Rtripod=K[varp]
I=value get "EI_3leavesVanishingIdeal_FinalBasis.txt"

CITripod=ideal{I_14};
dim CITripod, codim CITripod, degree CITripod 
...
betti CItripod --2 cubics
netList CItripod_*

----------------
-- Linear inv
----------------
-- All linear invariants of EI that are not linear invariants of EI
ILin=ideal(value get "EI_4leaves_linear.txt");
betti ILin

CIaux=trim(CIEdge+CItripod+ILin);
betti CIaux
...
CILinearTripod=ideal{I_0,I_1,I_2,I_3,I_4,I_5,I_6,I_7,I_8,I_9,I_10,I_11,I_12,I_13}
...
-------------------------------------------------------------
-- Linear invariants of F84
-------------------------------------------------------------
CILinearF84=ideal{(p_3*p_4*(p_3+p_4))*x_(2,3,2,3)-(p_1*p_2*(p_2+p_1))*x_(2,4,2,4),
...
CI=trim(CIEdge+CILinearF84+CItripod+CITripodLinear);
betti CI
